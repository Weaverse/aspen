    ...
    children: [
      {
        ...
        content:
          "We accept all major credit cards, PayPal, and bank transfers. Payment is secure and encrypted.",
      },
      {
        type: "accordion--item",
        ...
        content:
          "Shipping times vary depending on your location. Domestic orders typically arrive in 3-5 business days, while international orders may take 7-14 business days.",
      },
      {
        type: "accordion--item",
