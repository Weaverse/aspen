...
export interface CountdownHeadingProps
...
const CountdownHeading = forwardRef<
  HTMLHeadingElement,
  CountdownHeadingProps & Partial<HydrogenComponentProps>
>((props, ref) => {
  const {
    as: Tag = "h4",
    content,
  ...
  settings: [
    {
      ...
      inputs: [
        ...
        },
        {
          ...
          defaultValue: 16,
          condition: (data: CountdownHeadingProps) => data.size === "scale",
        },
        {
          type: "range",
          name: "maxSize",
        ...
        },
        {
          ...
          condition: (data: CountdownHeadingProps) => data.size === "custom",
          configs: {
            options: [
